...
import centipede.jni.Iterator;
import centipede.jni.WriteBatch;
...
public class DBTests extends AndroidTestCase {
    ...
    public void testBatchAndIterator() {
        final String[] keys = { "123","123abcde","200","foo1", "foo2", "foo3", "foo4", "foo5"};
        final String[] vals = { "123","1234","200","bar1", "bar2", "bar3", "bar4", "bar5" };
